...
console.log((function(){
    ...
    var params = {
        local: {'api': '2d14d1984a2e3293bd13aab34c85e2ea', 'protocol': 'http://', 'baseUrl': 'localhost:8080/zzishapi/api/', 'webUrl': 'http://localhost:3000/', 'logEnabled': true},
        test: {'api': '2d14d1984a2e3293bd13aab34c85e2ea', 'protocol': 'http://', 'baseUrl': 'test-api.zzish.com/api/', 'webUrl': 'http://test.zzish.com/'}
    };

    var testInitParams = params.test;
