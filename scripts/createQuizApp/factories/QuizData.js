        ...
        return {
            ...
            getQuiz: function(id, loadFromServer, callback){
                if(quizData !== undefined && quizData[id] !== undefined){
                    if(typeof quizData[id].questions + '' !== 'undefined' || (quizData[id].publicAssigned && !loadFromServer)){
            ...
            saveQuiz: function(quiz, topics){
                ...
                if (topics !== undefined) {
                    for (var i in topics) {
                        if (topics[i].newObject !== undefined && topics[i].newObject) {
                            ...
                            postTopic(topics[i]).success(function(){
                ...
                if (!savingQuiz) {
                    ...
                    savingQuiz = true;
                    $http.post('/create/' + userUuid + '/quizzes/' + quiz.uuid, quiz).success(function(){
            ...
            deleteQuiz: function(id, callback){
                ...
                delete quizData[id];
                localStorage.setItem('quizData', JSON.stringify(quizData));
                $http.post('/create/' + userUuid + '/quizzes/' + quiz.uuid + '/delete', {})
                    .success(function(){
                        callback();
                    });
            },
            ...
            unpublishQuiz: function(quizId, code){
                ...
                $http.post('/create/' + userUuid + '/quizzes/' + quizId + '/' + code + '/unpublish', {}).success(function(result){
                    ...
                    var idx = 0;
                    var found = false;
                    for (idx = 0; idx < groupContents[code].contents.length; idx++) {
