...
var CQAnalytics = React.createClass({
    ...
    componentDidMount: function() {
        ...
        console.log('this.user?', this.state.user, this.state.currentUser);
        // Intercom should be triggered only once.
        if (this.state.user){
    ...
    render: function() {
        ...
        console.info('CQAnalytics render', this.state.user, this.state.currentUser);
